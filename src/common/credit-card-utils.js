...
export function isCreditCardAccount(account: AccountRaw): boolean {
  return (
...
export function getCreditCardNumber(account: AccountRaw): string {
  invariant(
...
export function getCreditCardType(account: AccountRaw): CreditCardType {
