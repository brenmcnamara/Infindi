...
class OpenHSAAccount extends Component<RecommendationComponentProps> {
  render() {
    return (
      <View style={styles.root}>
        ...
        <View style={styles.menu}>
          <TextButton
            onPress={this._onPressLearnMoreHSAs}
  ...
  _onPressLearnMoreHSAs = (): void => {
    console.log('learn more about HSAs');
  };
}
